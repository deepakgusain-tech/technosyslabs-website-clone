                ...
                <form method="post" action="https://www.technosyslabs.com/Project.aspx?p=1"
                    ...
                    <div class="aspNetHidden">
                        ...
                        <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION"
                            value="/wEdAAfFq4j7o0NqmqnOEvs4TCPSD7y5ejT59jZSA8PnRjVCx5Q4dp0uNPsVbe8jiZVw7RMY2vLgY+SAqmEA6OiWKa5uhrXtViehLA82cCb/2h+dRk6QE5inkDVuRDI52S44dqyfVFyO0cCPrpER53fgJQ2eS1l3PJXmvq2hMvyaIoAdssy52SU=" />
                    </div>
                    <script type="text/javascript">
                        //<![CDATA[
                                        ...
                                        <div class="elementor-widget-container">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="section-title t_center">
                                                    ...
                                                    <h2><span id="ContentPlaceHolder1_DivTitle">Enhancing Efficiency
                                                            in Account Opening</span></h2>
                                                    <h4 id="ContentPlaceHolder1_DivSubTitle">A Case Study in RPA Bot
                                                        Implementation</h4>
                                                    <div class="bar-main">
                                                        ...
                                                        <div class="elementor-widget-container">
                                                            <div id="ContentPlaceHolder1_DivImage"
                                                                class="kc-elm kc-css-97285 kc_text_block"><img
                                                                    src=Upload/CaseStudy/businessmen-hands-white-table-with-documents-drafts_176420-3549d961098-fc63-4148-b7e2-3d3d4864de8d.jpg
                                                                    alt='' /></div>
                                                            ...
                                                            <div id="ContentPlaceHolder1_DivDescription"
                                                                ...
                                                                <p><strong>About the Client </strong><br />
                                                                    <br />
                                                                    This Organization is an investment bank which
                                                                    specializes in online trading and investment
                                                                    products.<br />
                                                                    <br />
                                                                    <strong>The Problem</strong><br />
                                                                    <br />
                                                                    The organization faced delays in the account
                                                                    opening process due to a manual approach,
                                                                    compounded by a rapidly expanding customer base.
                                                                    With approximately 2000-3000 service requests
                                                                    per month, the process required 24 full-time
                                                                    employees (FTEs) to handle 150-200 requests
                                                                    daily, leading to potential human errors.
                                                                    Additionally, the client required Management
                                                                    Information System (MIS) Reports to track
                                                                    service request statuses and transaction
                                                                    details.<br />
                                                                    <br />
                                                                    <strong>The Solution</strong><br />
                                                                    <br />
                                                                    To address these challenges, we implemented an
                                                                    automated account opening process using RPA
                                                                    (Robotic Process Automation) bots. Key
                                                                    components of the solution included:<br />
                                                                    &bull; Automated workflows for receiving,
                                                                    validating, and extracting data from account
                                                                    opening service request forms.<br />
                                                                    &bull; Identification and categorization of
                                                                    documents into the appropriate template buckets,
                                                                    considering variations in document types and
                                                                    formats.<br />
                                                                    &bull; Use of Optical Character Recognition
                                                                    (OCR) technology for data extraction from
                                                                    documents.Once data is extracted correctly from
                                                                    documents, the required data is stored in the
                                                                    data repository.<br />
                                                                    &bull; In case of exceptions such as
                                                                    insufficient information or poor document
                                                                    quality, bot stops the process execution and
                                                                    branches are notified for further
                                                                    response.<br />
                                                                    &bull; Automated workflow gets triggered for
                                                                    account opening. Opened account details and
                                                                    status of account requests is updated in
                                                                    database table with appropriate status.<br />
                                                                    &bull; Customers can view the status of the
                                                                    request on the bank portal.<br />
                                                                    <br />
                                                                    <strong>Value Added</strong><br />
                                                                    <br />
                                                                    &bull; 80% increase in overall efficiency.<br />
                                                                    &bull; 90% improvement in accuracy compared to
                                                                    the manual process.<br />
                                                                    &bull; Elimination of FTE involvement, leading
                                                                    to cost savings.<br />
                                                                    &bull; Maintenance and monitoring activities
                                                                    automated, ensuring error-free operations.<br />
                                                                    &nbsp;
                                                                </p>
                                                            </div>
                                                        </div>
