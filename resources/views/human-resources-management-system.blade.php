                ...
                <form method="post" action="https://www.technosyslabs.com/Services.aspx?s=27"
                    ...
                    <div class="aspNetHidden">
                        ...
                        <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION"
                            value="/wEdAAfwIhC3SnvBbvhjTfj3gy+nD7y5ejT59jZSA8PnRjVCx5Q4dp0uNPsVbe8jiZVw7RMY2vLgY+SAqmEA6OiWKa5uhrXtViehLA82cCb/2h+dRk6QE5inkDVuRDI52S44dqyfVFyO0cCPrpER53fgJQ2eNBSbt7/oFk5xSWwwzpubVIIymEA=" />
                    </div>
                    <script type="text/javascript">
                        //<![CDATA[
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="brpt ccase">
                            <h2 id="ContentPlaceHolder1_divhead">Human Resource Management </h2>
                        </div>
                        <div class="breadcumb-inner">
                            <p id="ContentPlaceHolder1_divpara">Automate core HR processes, including employee
                                records, attendance, leave, and payroll management</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="elementor-widget-wrap elementor-element-populated">
                                    <div class="elementor-element elementor-element-cb48409 elementor-widget elementor-widget-image"
                                        ...
                                        <div id="ContentPlaceHolder1_divImg" class="elementor-widget-container"><img
                                                ...
                                                src='Upload/Services/HRMS-01afa826d3-2996-431c-966c-e6be5c7b7d7f.png'
                                                        ...
                                                        <div class="elementor-widget-container"
                                                            ...
                                                            <div id="ContentPlaceHolder1_divContent"
                                                                ...
                                                                <p>This project involved the design and development
                                                                    ...
                                                                    System (HRMS) to streamline and automate core HR
                                                                    operations.</p>
                                                                <p>The platform provides a centralized system for
                                                                    managing employee information, attendance, leave
                                                                    requests, payroll, and performance evaluation
                                                                    while ensuring secure role-based access.</p>
                                                                <div><img fetchpriority="high" decoding="async"
                                                                        height="550" src="wp-content/images/HRMS_02.png"
                                                                ...
                                                                <div>&nbsp;</div>
                                                                <div><img fetchpriority="high" decoding="async"
                                                                        height="550" src="wp-content/images/HRMS_03.png"
                                                                        class="attachment-large size-large wp-image-771"
                                                                        alt=""
                                                                        sizes="(max-width:1000px) 50vw,500px" />
                                                                </div>
                                                                <h5>Key Features:</h5>
                                                                <p>Employee information and document management</p>
                                                                <p>Attendance and leave management</p>
                                                                <p>Payroll processing and salary tracking</p>
                                                                <p>Role-based access control</p>
                                                                <p>Performance evaluation and reporting</p>
                                                                <p>Notifications and workflow automation</p>
                                                                <p>Secure and scalable architecture</p>
                                                                <div><img fetchpriority="high" decoding="async"
                                                                        height="550" src="wp-content/images/HRMS_04.png"
                                                                        class="attachment-large size-large wp-image-771"
                                                                        alt=""
                                                                        sizes="(max-width:1000px) 50vw,500px" />
                                                                </div>
                                                                ...
                                                                <div>&nbsp;</div>
                                                                <div><img fetchpriority="high" decoding="async"
                                                                        height="550" src="wp-content/images/HRMS_05.png"
                                                                        class="attachment-large size-large wp-image-771"
                                                                        alt=""
                                                                        sizes="(max-width:1000px) 50vw,500px" />
                                                                </div>
                                                                ...
                                                                <div class='service-box service-style-nine'>
                                                                    <div class='service-box-content'>
                                                                        <div class='service-box-title'>
                                                                            <h2>Simplified HR operations</h2>
                                                                        </div>
                                                        ...
                                                        <div class='elementor-element elementor-element-633c329 elementor-widget elementor-widget-service'
                                                            ...
                                                            <div class='elementor-widget-container'>
                                                                <div class='service-box service-style-nine'>
                                                                    <div class='service-box-content'>
                                                                        <div class='service-box-title'>
                                                                            <h2>Increased process accuracy</h2>
                                                                        </div>
                                                                        <div class='service-box-desc'>
                                                                            <p style='text-align:justify'></p>
                                                                        </div>
                                                        ...
                                                        <div class='elementor-element elementor-element-633c329 elementor-widget elementor-widget-service'
                                                            ...
                                                            <div class='elementor-widget-container'>
                                                                <div class='service-box service-style-nine'>
                                                                    <div class='service-box-content'>
                                                                        <div class='service-box-title'>
                                                                            <h2>Improved workforce management</h2>
                                                                        </div>
                                                                        <div class='service-box-desc'>
                                                                            <p style='text-align:justify'></p>
                                                                        </div>
