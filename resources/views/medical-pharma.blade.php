                ...
                <form method="post" action="https://www.technosyslabs.com/Project.aspx?p=2"
                    ...
                    <div class="aspNetHidden">
                        ...
                        <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION"
                            value="/wEdAAfnVA4ZSq9qNkWZH9/Yi5BBD7y5ejT59jZSA8PnRjVCx5Q4dp0uNPsVbe8jiZVw7RMY2vLgY+SAqmEA6OiWKa5uhrXtViehLA82cCb/2h+dRk6QE5inkDVuRDI52S44dqyfVFyO0cCPrpER53fgJQ2eOX18j9qp30rkXHSHuxUe+kGLOm0=" />
                    </div>
                    <script type="text/javascript">
                        //<![CDATA[
                                        ...
                                        <div class="elementor-widget-container">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="section-title t_center">
                                                    ...
                                                    <h4 id="ContentPlaceHolder1_DivSubTitle">Medical/Pharma</h4>
                                                    <div class="bar-main">
                                                        ...
                                                        <div class="elementor-widget-container">
                                                            <div id="ContentPlaceHolder1_DivImage"
                                                                class="kc-elm kc-css-97285 kc_text_block"><img
                                                                    src=Upload/CaseStudy/medical-test-tubes-with-blood-desk-laboratory_482257-907458728000-00db-4855-b13e-e583ce6201e0.jpg
                                                                    alt='' /></div>
                                                            ...
                                                            <div id="ContentPlaceHolder1_DivDescription"
                                                                ...
                                                                <p><strong>About the Client </strong><br /><br />
                                                                    ...
                                                                    The company needed to automate a back-office
                                                                    process handling approximately 1800 invoices per
                                                                    month, requiring 3 full-time employees (FTEs).
                                                                    The process involved three departments using
                                                                    four applications, including MS Office and email
                                                                    on desktops. It dealt with unstructured
                                                                    information, while rules and decisions were
                                                                    pre-determined. Additionally, the process
                                                                    utilized paper and OCR technology.<br /><br />
                                                                    <strong>The Solution</strong><br /><br />
                                                                    A bot was deployed to extract data from incoming
                                                                    invoices via email and validate the PO number,
                                                                    number of items, and cost per item against the
                                                                    purchase order (PO) and goods received. The
                                                                    robot utilized ABBYY OCR to extract the data.
                                                                    Through RPA, the following applications were
                                                                    successfully automated with high accuracy: MS
                                                                    Office, Email, and SAP.<br /><br />
                                                                    <strong>Value Added</strong><br /><br />
                                                                    &bull; Automated 100% of the effort<br />
                                                                    &bull; Achieved an 80% reduction in costs
                                                                    annually<br />
                                                                    &bull; Increased operational quality and
                                                                    turnaround<br />
                                                                    &bull; Reduced error rate to 0%
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
